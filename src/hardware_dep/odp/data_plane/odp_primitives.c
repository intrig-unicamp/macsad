...
static void add_int_values(uint8_t *dst_ptr, const uint8_t *src_ptr1, const int src_len1, const uint8_t *src_ptr2, const int src_len2)
{
...
static void add_to_int_field(packet_descriptor_t* p, field_reference_t f, uint32_t src_val)
{
