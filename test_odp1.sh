...
make clean
make maco_controller
cd -

echo "odp ctrl make done"

# Restart test controller in background
sudo killall maco_controller
sudo killall maco_l3_controller
sudo killall maco_l3-full_controller
./src/hardware_dep/shared/ctrl_plane/maco_controller &
